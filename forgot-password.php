...
<!-- Mirrored from ableproadmin.com/bootstrap/default/auth-reset-password-img-side.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Jan 2022 10:43:08 GMT -->
<head>
	...
	<div class="flex-grow-1">
		<div class="h-100 d-md-flex align-items-center auth-side-img">
			<div class="col-sm-10 auth-content w-auto">
				...
				<h4 class="text-white font-weight-normal">Hi, Answer this security question to reset your password</h4>
			</div>
		</div>
		<div class="auth-side-form">
			<div class=" auth-content">
				...
				<form action="reset-password.php">
							<textarea name="" id="" class="form-control">What is your Mother maiden Name?</textarea>
						
						<div class="form-group mb-4">
							<label class="floating-label" for="Username">Your Answer</label>
							<input type="email" class="form-control" id="Username">
						</div>
						<button class="btn btn-block btn-warning mb-4">Submit Answer</button>
						<p class="mb-0 text-muted">Remember Password? <a href="login.php" class="f-w-400">Sign In Here</a></p>
						</form>
