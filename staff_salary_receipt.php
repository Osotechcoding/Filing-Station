...
<head>
    <title>Staff Salary Receipt -PMS</title>
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Adeola Adewumi</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index-2.html"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#!">March 2022 Receipt</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div>
                    ...
                    <div class="row text-center">
                        <div class="col-sm-12 invoice-btn-group text-center">
                            ...
                            <a href="salary_history.php"><button type="button" class="btn waves-effect waves-light btn-danger m-b-10 ">Go Back</button></a>
                        </div>
                    </div>
                </div>
            </div>
